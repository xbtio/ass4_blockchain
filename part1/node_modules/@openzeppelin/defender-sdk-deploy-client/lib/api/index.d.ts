...
import { ApprovalProcessResponse, BlockExplorerApiKeyResponse, CreateBlockExplorerApiKeyRequest, DeployContractRequest, DeploymentConfigCreateRequest, DeploymentConfigResponse, DeploymentResponse, RemoveBlockExplorerApiKeyResponse, RemoveDeploymentConfigResponse, UpdateBlockExplorerApiKeyRequest, UpgradeContractRequest, UpgradeContractResponse } from '../models';
...
export declare class DeployClient extends BaseApiClient {
    ...
    getConfig(id: string): Promise<DeploymentConfigResponse>;
    listConfig(): Promise<DeploymentConfigResponse[]>;
    ...
    createConfig(params: DeploymentConfigCreateRequest): Promise<DeploymentConfigResponse>;
    updateConfig(id: string, params: DeploymentConfigCreateRequest): Promise<DeploymentConfigResponse>;
    removeConfig(id: string): Promise<RemoveDeploymentConfigResponse>;
}
